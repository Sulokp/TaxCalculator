...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        lblNewLabel.setBounds(74, 24, 104, 25);
        contentPane.add(lblNewLabel);

        textField = new JTextField();
        textField.setBounds(100, 88, 96, 19);
        contentPane.add(textField);
        textField.setColumns(10);

        passwordField = new JPasswordField();
        passwordField.setBounds(101, 135, 95, 19);
        contentPane.add(passwordField);

        JLabel lblNewLabel_1 = new JLabel("Email");
        lblNewLabel_1.setBounds(55, 91, 45, 13);
        contentPane.add(lblNewLabel_1);

        JLabel lblNewLabel_2 = new JLabel("Password");
        lblNewLabel_2.setBounds(41, 138, 45, 13);
        ...
        btnNewButton.setBounds(74, 188, 85, 21);
        contentPane.add(btnNewButton);

        JLabel lblNewLabel_3 = new JLabel("If you don't have an account, please");
        lblNewLabel_3.setBounds(41, 251, 170, 13);
        ...
        btnNewButton_1.setBounds(74, 278, 85, 21);
